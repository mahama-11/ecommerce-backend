...
func (h *Handler) ListCatalog(c *gin.Context) {
	...
	if err != nil { response.JSONErrorSemantic(c, response.CodeInternalError, "failed to load template catalog", "TEMPLATE_CATALOG_LOAD_FAILED", "Please try again later."); return }
...
func (h *Handler) Facets(c *gin.Context) {
	...
	if err != nil { response.JSONErrorSemantic(c, response.CodeInternalError, "failed to load template facets", "TEMPLATE_FACETS_LOAD_FAILED", "Please try again later."); return }
	response.JSONSuccess(c, items)
}
...
func (h *Handler) Recommendations(c *gin.Context) {
	...
	if err != nil { response.JSONErrorSemantic(c, response.CodeInternalError, "failed to load recommendations", "TEMPLATE_RECOMMENDATION_LOAD_FAILED", "Please try again later."); return }
	response.JSONSuccess(c, items)
}
...
func (h *Handler) Detail(c *gin.Context) {
	...
	if err != nil { response.JSONErrorSemantic(c, response.CodeNotFound, "template not found", "TEMPLATE_NOT_FOUND", "Check the template id and try again."); return }
...
func (h *Handler) Favorites(c *gin.Context) {
	...
	if err != nil { response.JSONErrorSemantic(c, response.CodeInternalError, "failed to load favorites", "TEMPLATE_FAVORITES_LOAD_FAILED", "Please try again later."); return }
	response.JSONSuccess(c, items)
}
...
func (h *Handler) AddFavorite(c *gin.Context) {
	...
	defer span.End()
	if err := h.service.AddFavorite(c, scopeFromContext(c), c.Param("templateId")); err != nil { response.JSONErrorSemantic(c, response.CodeInternalError, "failed to favorite template", "TEMPLATE_FAVORITE_FAILED", "Please try again later."); return }
...
func (h *Handler) RemoveFavorite(c *gin.Context) {
	...
	defer span.End()
	if err := h.service.RemoveFavorite(c, scopeFromContext(c), c.Param("templateId")); err != nil { response.JSONErrorSemantic(c, response.CodeInternalError, "failed to unfavorite template", "TEMPLATE_UNFAVORITE_FAILED", "Please try again later."); return }
...
func (h *Handler) CopyToMyTemplates(c *gin.Context) {
	...
	if err != nil { response.JSONErrorSemantic(c, response.CodeInternalError, "failed to copy template", "TEMPLATE_COPY_FAILED", "Please try again later."); return }
...
func (h *Handler) Use(c *gin.Context) {
	...
	if err != nil { response.JSONErrorSemantic(c, response.CodeInternalError, "failed to resolve template use route", "TEMPLATE_USE_FAILED", "Please try again later."); return }
