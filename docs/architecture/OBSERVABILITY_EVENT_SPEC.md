...
ecommerce.runtime.callback.update.started
ecommerce.runtime.callback.update.finished
ecommerce.runtime.callback.update.failed
ecommerce.runtime.callback.results.started
ecommerce.runtime.callback.results.finished
ecommerce.runtime.callback.results.failed
...
ecommerce.runtime.charge.release.started
ecommerce.runtime.charge.release.finished
ecommerce.runtime.charge.release.failed
...
platform.runtime.provider.create.started
platform.runtime.provider.create.finished
platform.runtime.provider.create.failed
platform.runtime.job.create.started
platform.runtime.job.create.finished
platform.runtime.job.create.failed
platform.runtime.provider.callback.started
platform.runtime.provider.callback.finished
platform.runtime.provider.callback.failed
```

Batch 4 core-chain events:

```text
ecommerce.auth.register.started
ecommerce.auth.register.finished
ecommerce.auth.register.failed
ecommerce.auth.login.started
ecommerce.auth.login.finished
ecommerce.auth.login.failed
ecommerce.auth.session.verify.started
ecommerce.auth.session.verify.finished
ecommerce.auth.session.verify.failed

ecommerce.commercial.order.create.started
ecommerce.commercial.order.create.finished
ecommerce.commercial.order.create.failed
ecommerce.commercial.payment.confirm.started
ecommerce.commercial.payment.confirm.finished
ecommerce.commercial.payment.confirm.failed
ecommerce.commercial.payment.idempotency.hit

ecommerce.wallet.summary.started
ecommerce.wallet.summary.finished
ecommerce.wallet.summary.failed
ecommerce.wallet.history.started
ecommerce.wallet.history.finished
ecommerce.wallet.history.failed
```
